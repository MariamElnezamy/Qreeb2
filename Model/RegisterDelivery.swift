...
// MARK: - RegisterDeliveryResponse
struct RegisterDeliveryResponse: Codable {
    let value: Bool
    let data: DataClassRegisterDeliveryResponse
    let comment: String
}

// MARK: - DataClass
struct DataClassRegisterDeliveryResponse: Codable {
